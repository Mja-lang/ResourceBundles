...
public class DateApplication {
        ...
        public void setFrench() {
            ...
            // Set messages
            messages = ResourceBundle.getBundle("message_fr", Locale.FRANCE);
        }
        public void setItaly() {
            currentLocale = Locale.ITALY;
            // Set messages
            messages = ResourceBundle.getBundle("message_it", Locale.ITALY);
        }
        public void setJapanese() {
            currentLocale = Locale.JAPAN;
            // Set messages
            messages = ResourceBundle.getBundle("message_ja", Locale.JAPAN);
        }
